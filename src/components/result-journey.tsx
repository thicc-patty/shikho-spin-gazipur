...
import { APP_URL, COMMUNITY_URL, PRIZE_BY_ID, type EntryView } from "@/lib/game";
...
export function ResultJourney({entry,demo,record,onReplay,page,onPageChange,onBack}:{entry:EntryView;demo:boolean;record:(name:string)=>void;onReplay:()=>void;page:number;onPageChange:(page:number)=>void;onBack:()=>void}){
