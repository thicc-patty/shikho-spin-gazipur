...
const base:EntryRow={
  id:"00000000-0000-4000-8000-000000000001",phone:"8801712345678",name:"রাফি আহমেদ",study_group:"science",class_level:"c11",spins:1,
...
test("CRM lead payload uses the documented identity and student values",()=>{
  assert.deepEqual(leadPayload(base),{
    mobile:"8801712345678",product_id:"1",source:"Social Media Form",campaign:"S26_Spin",name:"রাফি আহমেদ",
...
test("CRM completion event keeps one venue form name and stores the exact outcome in cf_result",()=>{
  ...
  assert.deepEqual(payload,{
    ...
    created_at:"2026-09-10 14:32:07",cf_form_name:"S26_Spin_Chattogram",cf_result:"DISCOUNT_20",cf_form_type:"ORGANIC",
    cf_class:"C11",cf_passing_year:"2028",cf_group:"VOC",cf_sub_status:"Unpaid",
  });
  assert.equal(crmFormValue({...base.event_info,id:"coxs-bazar"}),"S26_Spin_Coxs_Bazar");
  const results={
